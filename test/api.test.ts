...
describe("API", () => {
  ...
  it("walk", () =>
    new Promise((done) => {
      ...
      const reference =
        '<div class="cls"><header class="test" id="index2"><div class="cls test" id="index3">Text</div></header></div>';
  ...
  describe("match", () => {
    ...
    it("Array with multiple matches", () =>
      new Promise((done) => {
