...
function PostHTML (plugins) {
  ...
  /**
   * @example
   * if ( ctx.processor.version.split('.')[1] !== '9' ) {
   *   throw new Error('This plugin works only with PostHTML 9');
   * }
   */
  this.version = '0.9.1'
  /**
   * @example
   * see https://github.com/post-org/post-load-plugins#nodejs-with-posthtml
   */  
  this.name = 'posthtml'
}
